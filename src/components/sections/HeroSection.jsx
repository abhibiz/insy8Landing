                ...
                <div className="relative aspect-[16/11] w-full overflow-hidden rounded-[2rem] bg-slate-950/95 sm:aspect-[16/10]">
                  {previewSlide === 0 ? (
                    ...
                    <div className="absolute inset-0 overflow-hidden rounded-[2rem] bg-gradient-to-br from-slate-950/95 to-slate-900/90 p-6 sm:p-8">
                      <div className="h-full rounded-[1.75rem] border border-white/10 bg-white/5 p-6 shadow-[0_40px_80px_-50px_rgba(0,0,0,0.8)] backdrop-blur-xl">
                        <div className="grid gap-5 lg:grid-cols-[auto_minmax(0,1fr)] lg:items-center">
                          <div className="flex h-20 w-20 items-center justify-center rounded-3xl bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-500 text-white shadow-lg shadow-blue-500/25">
                          ...
                          <ul className="space-y-3">
                            {previewBullets.map((item) => (
                              <li key={item} className="flex items-start gap-3 text-sm leading-relaxed text-zinc-300">
                                <span className="mt-1 inline-flex h-2.5 w-2.5 rounded-full bg-blue-400" aria-hidden />
                                <span>{item}</span>
                              </li>
                            ))}
                          </ul>
